 ...
 *
 * Modified to work with jQuery 1.9
 * Copyright 2013 Christoph M. Becker
 */
        ...
        base.setImage = function() {
          for(base.b = 1;base.b < base.anz + 1; base.b++) // alle Bilder durchlaufen
          {
            ...
            if (base.image[base.b-1])
            {
              ...
              andSelf($('#cBlock'+base.el.id+''+base.b+'').children()).css('width', base.image[base.b-1]["width"]/(base.sc+1));
              andSelf($('#cBlock'+base.el.id+''+base.b+'').children()).css('z-index', zIndex);
              $('#cBlock'+base.el.id+''+base.b+'').children('.cImage').css('height', base.image[base.b-1]["height"]/(base.sc+1));
              //andSelf($('#cBlock'+base.el.id+''+base.b+'').children('.cOverlay')).css('height', (base.image[base.b-1]["height"]+base.reflection)/(base.sc+1));
